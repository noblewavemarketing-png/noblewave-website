      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-2xl max-w-3xl mx-auto mb-8 font-light leading-relaxed">
            NobleWave is based right here in the GTA — qualified, exclusive homeowner leads sent straight to your phone for renovation and HVAC companies serving {city}. One flat rate. No contracts. No shared leads.
          </p>
