  ...
  return (
    <PageShell>
      <PageHeader
        ...
        title={<>Booked Jobs. <span className="italic text-noble-blue">Not Clicks.</span></>}
      ...
      <section className="py-24 md:py-28 bg-noble-dark">
        <div className="max-w-3xl mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-10 md:p-14 bg-noble-black border border-noble-blue/30 rounded-[2.5rem] text-center"
          >
            ...
            <a href="/contact" data-track="cta" className="inline-block bg-noble-blue text-noble-black px-10 py-4 rounded-full font-bold hover:bg-white transition-all">
              Request Your Quote
            </a>
